...
require (
	...
	github.com/goccy/bigquery-emulator v0.2.10
...
replace github.com/goccy/go-zetasqlite v0.13.0 => github.com/dav009/go-zetasqlite v0.0.0-20230109094719-5e4a75239ddf
